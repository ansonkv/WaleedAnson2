...
class AreaCitySpinnerAdapter(
    val context: Context,
    var listGovernorate: ArrayList<AreaCityListResponse.AreaCity>
) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        vh.label.setLanguageString(
            listGovernorate[position].areaCityName,
            listGovernorate[position].areaCityNameAr
        )
